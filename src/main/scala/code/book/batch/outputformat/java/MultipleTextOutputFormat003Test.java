 ...
 */
public class MultipleTextOutputFormat003Test {
    public static void main(String[] args) throws Exception {
        ...
        MultipleTextOutputFormat002<String, String> multipleTextOutputFormat = new MultipleTextOutputFormat002<>();
        JobConf jobConf = new JobConf();
        String filePath = "hdfs://qingcheng12:9000/output/flink/MultipleTextOutputFormat/java/002";
